...
public class LiveTask extends TaskModule {
  ...
  @ConfigValue private int itemlivetime;

  @ConfigValue private int moblivetime;

  @ConfigValue private int arrowkilltime;

  @ConfigValue private boolean itemtimer;

  @ConfigValue private boolean mobtimer;

  @ConfigValue private boolean arrowtimer;
