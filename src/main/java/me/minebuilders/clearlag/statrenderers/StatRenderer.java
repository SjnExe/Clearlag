...
public abstract class StatRenderer extends MapRenderer implements Runnable {
  ...
  public StatRenderer(
    ...
    taskId =
        Bukkit.getScheduler().runTaskTimer(Clearlag.getInstance(), this, sampleTicks, sampleTicks);
  }
  ...
  public void run() {
    ...
    if (!observer.isOnline()
        || observer.getItemInHand() == null
        || !versionAdapter.isMapItemStackEqual(observer.getItemInHand(), mapItemStack)) {
