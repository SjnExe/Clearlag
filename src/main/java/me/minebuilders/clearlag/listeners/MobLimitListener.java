...
public class MobLimitListener extends EventModule implements Runnable {
  ...
  @ConfigValue private int animals;

  @ConfigValue private int mobs;

  @ConfigValue private int interval;
    ...
    sched =
        Bukkit.getScheduler()
            .scheduleSyncRepeatingTask(
                Clearlag.getInstance(), this, interval * 20L, interval * 20L);
  }
  ...
  public void onMobSpawn(CreatureSpawnEvent e) {
    ...
    if (!canAnimalspawn && en instanceof Animals) e.setCancelled(true);
    else if (!canMobspawn && en instanceof Creature) e.setCancelled(true);
  }
}
