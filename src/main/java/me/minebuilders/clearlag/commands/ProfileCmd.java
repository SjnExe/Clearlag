...
public class ProfileCmd extends CommandModule {
  ...
  private final ProfilerFactory[] profilerFactories =
      new ProfilerFactory[] {
  ...
  protected void run(final CommandSender sender, String[] args)
        ...
        chunkKeyMutableIntMap -> {
          ...
          for (int i = 0; i < sizes.length; i++) {
            ...
            lineMessage.sendMessage(
                sender, (i + 1), c.getWorld().getName(), c.getX(), c.getZ(), sizes[i]);
          }
        };
    ...
    if (profileSession == null) {
      ...
      throw new WrongCommandArgumentException(
          lang.getMessage("invalidprofiler"), args[1], sb.toString());
    }
  ...
  private abstract static class ProfileSession extends BukkitRunnable implements Listener {
