...
public class LimitClear extends ClearModule {
  ...
  @ConfigValue private boolean item;

  @ConfigValue(valueType = ConfigValueType.MATERIAL_SET)
  private Set<Material> itemFilter;

  @ConfigValue private final List<String> worldFilter = new ArrayList<String>();
  @ConfigValue private boolean itemframe;
  @ConfigValue private boolean fallingBlock;
  @ConfigValue private boolean boat;
  @ConfigValue private boolean experienceOrb;
  @ConfigValue private boolean painting;
  @ConfigValue private boolean projectile;
  @ConfigValue private boolean primedTnt;
  @ConfigValue private boolean minecart;
